...
- (void)videosForPlaylistName:(NSString *)playlistName forChannelIdentifier:(NSString *)channelIdentifier onCompletion:(void (^)(BOOL succeeded, NSArray *videos, NSError *error))completionBlock
{
    NSParameterAssert(playlistName);
...
- (void)videosForChannelIdentifier:(NSString *)channelIdentifier onCompletion:(void (^)(BOOL succeeded, NSArray *playlists, NSError *error))completionBlock
{
    NSParameterAssert(channelIdentifier);
...
- (void)channelForIdentifier:(NSString *)channelIdentifier onCompletion:(void (^)(BOOL succeeded, GTLYouTubeChannel *channel, NSError *error))completionBlock
{
    NSParameterAssert(channelIdentifier);
